...
public class OI extends DefaultOI {
    ...
    public JoystickButton shooter_1, stopShooter_2;
    ...
    public OI(){
        super();
        shooter_1 = new JoystickButton(super.operatorJoy, 1);
        stopShooter_2 = new JoystickButton(super.operatorJoy, 2);
        ...
        shooter_1.whenPressed(new Shooting());
        stopShooter_2.whenPressed(new StopShooting());
