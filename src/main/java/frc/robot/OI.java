...
import static frc.robot.Robot.hood;
...
public class OI extends DefaultOI {
    ...
    public OI() {
        ...
        // SmartDashboard.putData("-SetHoodPower", new SetMotorPower(Robot.hood,
        // -0.125));
        ...
        SmartDashboard.putData("3VHopper", new SetDualMotorPower(Robot.hopper, 0.25, 0.25));
