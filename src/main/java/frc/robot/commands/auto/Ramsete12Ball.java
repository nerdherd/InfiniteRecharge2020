...
public class Ramsete12Ball extends SequentialCommandGroup {
  /**
   * sike tis ten ball
   */
  private Drivetrain m_drive;
    public Ramsete12Ball(Drivetrain drive) {
    m_drive = drive;
    ...
    Trajectory m_traj0 = TrajectoryGenerator.generateTrajectory(new Pose2d(6.359, -7.506, new Rotation2d(0)),
    ...
    List.of(), new Pose2d(3.048, -2.404, new Rotation2d(0)),
     ...
     RamseteCommand ramsete = new RamseteCommand(m_traj, m_drive::getPose2d, new RamseteController(2.0, 0.7), 
      ...
      Trajectory m_traj3 = TrajectoryGenerator.generateTrajectory(new Pose2d(3.048, -2.404, new Rotation2d(0)),
      ...
      Trajectory m_traj4 = TrajectoryGenerator.generateTrajectory(new Pose2d(6.163, -3.014, new Rotation2d(0.4548)),
      ...
      Trajectory m_traj5 = TrajectoryGenerator.generateTrajectory(new Pose2d(4.097, -2.404, new Rotation2d(Math.PI)),
      ...
      addCommands(ramsete0, ramsete, ramsete3, ramsete4, ramsete5, new DriveStraightContinuous(m_drive, 0, 0));
